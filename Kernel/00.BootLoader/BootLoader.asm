...
TOTALSECTORCNT:		dw 50	; 부트 로더를 제외한 OS 이미지의 크기. 최대 1152 섹터(0x90000byte)까지 가능
KERNEL32SECTORCNT:	dw 5	; 보호 모드 커널의 총 섹터 수
BOOTSTRAPPROCESSOR:	db 0x00	; Bootstrap Processor인지 여부
ISGRAPHICMODE:		db 0x00	; 그래픽 모드로 시작하는지 여부
